...
export const config = {
  ...
  allowedOrigins: process.env.ALLOWED_ORIGINS ? process.env.ALLOWED_ORIGINS.split(',') : ['http://localhost:3000', 'http://localhost:3001', 'http://razormxc.beget.tech', 'https://localhost:4000'],
